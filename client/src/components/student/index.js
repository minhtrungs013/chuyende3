      ...
      <form>
        <div>
          ...
          <button
            id="md-them"
            type="button"
            className="grid wide btnStudent"
            data-toggle="modal"
          ...
          <div className="grid wide home-candidate">
            <div className="row home-candidate--list">
              ...
              <span className="col l-2-8-student ">địa chỉ</span>
              <span className="col l-2-8-student ">Trường</span>
              <span className="col l-2-8-student ">người hướng dẫn</span>
              <span className="col l-2-8-student ">Số điện thoại</span>
              <span className="col l-2-8-student ">Dự án</span>
              <span className="col l-2-8-student ">Trạng thái TTr</span>
            ...
            <div className="table-body-internships">
              {posts?.map((students) => (
                <ul className="row sm-gutter sm-gutter--lisst">
                  ...
                  <li className="col l-2-8-student">{students.address}</li>
                      ...
                      <tr>
                        ...
                        <td>
                          <input
                            tabindex="-1"
                            className="inputDetail"
                            value={dayjs(values.testDate).format("DD-MM-YYYY")}
                            disabled
                          />
                        </td>
                        <td className="right-modal">
